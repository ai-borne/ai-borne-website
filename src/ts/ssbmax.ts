...
import { SSBMaxViewModel } from '../viewmodels/SSBMaxViewModel';
...
export function renderSSBMaxPage(): void {
  const viewModel = new SSBMaxViewModel();
  ...
  appEl.innerHTML = `
    ...
    <main class="main-content">
      ...
      <section class="container section">
        <h2 class="section-title text-center mb-xl">${strings.ssbmax.keyFeaturesTitle}</h2>
        <div class="grid-3">
          ${app.features
            .map(
              (feature) => `
...
if (typeof window !== 'undefined') {
  document.addEventListener('DOMContentLoaded', () => renderSSBMaxPage());
}
